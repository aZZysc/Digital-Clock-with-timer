...
namespace clock
{
    public partial class MainPage : ContentPage
    {
        ...
        {
            top.Source = ImageSource.FromFile("fill.png");      //Все фотки в \clock\Resources\Images
            middle.Source = ImageSource.FromFile("fill.png");
            bottom.Source = ImageSource.FromFile("fill.png");
            topLeft.Source = ImageSource.FromFile("fill.png");
            topRight.Source = ImageSource.FromFile("fill.png");
            bottomLeft.Source = ImageSource.FromFile("fill.png");
            bottomRight.Source = ImageSource.FromFile("fill.png");
